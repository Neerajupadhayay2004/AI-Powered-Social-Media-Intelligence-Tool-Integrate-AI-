...
import { Activity, MessageSquare, Moon, ScanLine, Search, Shield, Sun } from "lucide-react";
		...
		children: [
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(Shield, { className: "h-4 w-4" })
							}), /* @__PURE__ */ jsxs("div", {
								className: "min-w-0",
								children: [/* @__PURE__ */ jsxs("div", {
									className: "font-mono text-sm font-bold leading-none tracking-tight",
									children: ["SENTINEL", /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsx("nav", {
							...
							children: nav.map((n) => {
								...
								return /* @__PURE__ */ jsxs(Link, {
									...
									children: [/* @__PURE__ */ jsx(n.icon, { className: "h-3.5 w-3.5" }), n.label]
								}, n.to);
							})
						}),
						/* @__PURE__ */ jsx("button", {
					...
					children: nav.map((n) => {
						...
						return /* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx(n.icon, { className: "h-3 w-3" }), n.label]
						}, n.to);
					})
				})]
			}),
			...
			/* @__PURE__ */ jsx("footer", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: "Sentinel/AI · OSINT analytics for public content only" }), /* @__PURE__ */ jsx("span", { children: "v0.1 · No scraping · No ToS violations" })]
				})
			})
		]
	});
...
//#endregion
export { saveAnalysis as a, loadHistory as i, deleteAnalysis as n, AppShell as o, getById as r, cn as s, clearHistory as t };
